    ...
    <div className="_container">
      ...
      {modal && (
        <OrderModal visible={modal} setVisible={setModal}>
          <h1 className="order-modal__title">Спасибо за заказ</h1>
          <p className="order-modal__text">Наш менеджер свяжется с вами в ближайшее время</p>
          <button className='order-modal__btn-close' onClick={() => setModal(false)}>
