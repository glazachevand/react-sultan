...
import cl from './OrderModal.module.scss'
  ...
  return (
    <div className={visible ? `${cl.orderModal} ${cl.orderModal_open}` : cl.orderModal} onClick={() => setVisible(false)} data-testid="order-modal">
      <div className={cl.orderModal__content} onClick={(e) => e.stopPropagation()}>
        ...
        <p className={cl.orderModal__text}>Наш менеджер свяжется с вами в ближайшее время</p>
        <button className={cl.orderModal__btnClose} onClick={() => setVisible(false)}>
